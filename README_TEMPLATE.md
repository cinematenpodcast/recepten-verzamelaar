...
1. Download de nieuwste APK van de [Releases](https://github.com/GEBRUIKERSNAAM/recepten-verzamelaar/releases) pagina
...
```bash
# Clone de repository
git clone https://github.com/GEBRUIKERSNAAM/recepten-verzamelaar.git
...
- GitHub: [@GEBRUIKERSNAAM](https://github.com/GEBRUIKERSNAAM)
...
- 📧 Open een [Issue](https://github.com/GEBRUIKERSNAAM/recepten-verzamelaar/issues)
- 💬 Start een [Discussion](https://github.com/GEBRUIKERSNAAM/recepten-verzamelaar/discussions)
